...
public class PatientForm extends javax.swing.JInternalFrame {
    ...
    public PatientForm() {
        ...
        model = (DefaultTableModel) ListePatient.getModel();
       load();
        loadService();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Gestion des patients"));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(serviceTxt, 0, 151, Short.MAX_VALUE)
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Liste des patients"));
...
// TODO add your handling code here:
        id = Integer.parseInt(model.getValueAt(ListePatient.getSelectedRow(), 0).toString());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            int clientId = (int) ListePatient.getValueAt(selectedRow, 0);
            System.out.println("Patient ID sélectionné : " + clientId);

            Patient selectedPatient = cs.findById(clientId);
            System.out.println("Patient sélectionné : " + selectedPatient);
            ...
            selectedPatient.setNom(newNom);
            selectedPatient.setPrenom(newPrenom);
            selectedPatient.setDate(newDate);
            selectedPatient.setService(newService);

            boolean updated = cs.update(selectedPatient);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        cs.create(new Patient(nomTxt.getText(), prenomTxt.getText(), dateTxt.getDate(), servi));
